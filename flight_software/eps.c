...
void delay(int n)
{
    for (int i = 0; i < n; i++) //according to previous n-1000
    {
        // delay 6ms ish
    }
}
...
float i2c_eps_batteryOutputVoltage()
{
     ...
     * I don't know if this calculation is correct
     */
     // I believe its 7 because it is 0 inclusive
    adc_count = (g_slave_buff[1] << 7) | g_slave_buff[0]; //talk about bit manipulation
